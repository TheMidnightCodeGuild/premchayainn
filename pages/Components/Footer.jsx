...
const Footer = () => {
  return (
    <>
      ...
      <footer className="text-black font-semibold border-t border-white bg-[#c5c5e4] py-10 sm:py-10 flex justify-center items-center bottom-0 left-0 right-0">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-lg sm:text-xl">
              © {new Date().getFullYear()} Prem Chaya Inn | Website
